export default function About() {
  return (
    <div className="min-h-screen bg-white text-gray-800 flex items-center justify-center">
      <div className="container mx-auto px-6 lg:px-12 py-12 space-y-16">
        {/* About Me Section */}
        <section className="text-center">
          <h1 className="text-5xl font-extrabold tracking-tight text-transparent bg-clip-text bg-gradient-to-r from-purple-600 via-pink-500 to-teal-400">
            About Me
          </h1>
          <p className="mt-8 text-lg leading-relaxed text-gray-600 max-w-4xl mx-auto">
        ...
        {/* Education Section */}
        <section className="text-center">
          <h1 className="text-4xl font-extrabold tracking-tight text-transparent bg-clip-text bg-gradient-to-r from-teal-400 via-green-500 to-purple-600">
            Education
          </h1>
